...
$surfaceDirectories = [ordered]@{
    ...
    hermesSkills = Join-Path $root '.hermes\skills'
    hermesAgents = Join-Path $root '.hermes\agents'
    hermesPlugins = Join-Path $root '.hermes\plugins'
    devinSkills = Join-Path $root '.devin\skills'
    devinAgents = Join-Path $root '.devin\agents'
